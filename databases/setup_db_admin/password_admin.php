              ...
              <div class="content">
                  <form action="" method="post">
                      <div class="input-field" >
                          <input type="text" id="id_number" name="email" placeholder="Re-enter the registered email ">
                      </div>
                      <div class="input-field" >
                          <input type="password" id="password" name="verification" placeholder="enter verification sent to your email">
                      </div>
                      <div class="input-field">
