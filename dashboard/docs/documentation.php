...
<head>
  ...
  <title>
    Independent Electral Boundary and Commision
  </title>
  ...
  <nav class="navbar navbar-expand-lg navbar-transparent  bg-primary  navbar-absolute">
    <div class="container">
      <div class="navbar-wrapper">
        ...
        <a class="navbar-brand" href=""> <h5>Independent Electral  Boundary and Commision</h5></a>
      </div>
      ...
      <div class="collapse navbar-collapse justify-content-end" id="navigation">
        <ul class="navbar-nav">
          ...
          <li class="nav-item">
            <a class="nav-link" href="http://localhost/html/php_repo/IEBC/general_action/check_session.php" target="_blank">
              Back to dashboard
            </a>
          </li>
        </ul>
  ...
  <div class="page-header clear-filter" filter-color="orange">
    ...
    <div class="container text-center">
      <!-- <div class="col-md-8 ml-auto mr-auto"> -->
        <!-- <div class="brand"> -->
          <h1 class="title">
            Independent Electral of Boundary and Commision
          </h1>
